...
namespace SMMS.Repositories.PhucTM.Basic
{
	public class GenericRepository<T> where T : class
	{
		protected SU25_PRN232_SE1725_G2_SchoolMedicalManagementSystemContext _context;

		public GenericRepository()
		{
			_context ??= new SU25_PRN232_SE1725_G2_SchoolMedicalManagementSystemContext();
		}

		public GenericRepository(SU25_PRN232_SE1725_G2_SchoolMedicalManagementSystemContext context)
		{
			_context = context;
		}
