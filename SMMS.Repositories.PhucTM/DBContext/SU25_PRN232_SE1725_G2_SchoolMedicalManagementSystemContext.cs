...
namespace SMMS.Repositories.PhucTM.DBContext;

public partial class SU25_PRN232_SE1725_G2_SchoolMedicalManagementSystemContext : DbContext
{
    public SU25_PRN232_SE1725_G2_SchoolMedicalManagementSystemContext()
    {
    }

    public SU25_PRN232_SE1725_G2_SchoolMedicalManagementSystemContext(DbContextOptions<SU25_PRN232_SE1725_G2_SchoolMedicalManagementSystemContext> options)
        : base(options)
    {
    }
	...
	//        => optionsBuilder.UseSqlServer("Data Source=PHUC\\PHUC;Initial Catalog=SU25_PRN232_SE1725_G2_SchoolMedicalManagementSystem;Persist Security Info=True;User ID=sa;Password=1234567890;Encrypt=False");
	...
	protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.CheckupScheduleHuyLqid).HasName("PK__CheckUpS__7FAE88859BE6245D");
        ...
        {
            entity.HasKey(e => e.EventTypePhucTmid).HasName("PK__EventTyp__D94AC36C0812EEDE");
        ...
        {
            entity.HasKey(e => e.HealthProfileTypesTienVlnid).HasName("PK__HealthPr__DAED1B3C0FB765AD");
        ...
        {
            entity.HasKey(e => e.CheckupHuyLqid).HasName("PK__MedicalC__146E0941533936FA");
        ...
        {
            entity.HasKey(e => e.MedicalEventPhucTmid).HasName("PK__MedicalE__B24A8EDF9014BD50");
        ...
        {
            entity.HasKey(e => e.MedicationCategoryQuanTnid).HasName("PK__Medicati__58B4DA1A84F87975");
        ...
        {
            entity.HasKey(e => e.MedicationQuanTnid).HasName("PK__Medicati__EC3AEDC429545E1A");
        ...
        {
            entity.HasKey(e => e.RequestNghiaHtid).HasName("PK__RequestN__0F93465440190A1A");
        ...
        {
            entity.HasKey(e => e.StudentHealthProfilesTienVlnid).HasName("PK__StudentH__790C99B5FEC2A438");
        ...
        {
            entity.HasKey(e => e.VaccinationLongTnid).HasName("PK__Vaccinat__80197F6E1DB952FF");
        ...
        {
            entity.HasKey(e => e.VaccineTypeLongTnid).HasName("PK__VaccineT__2460A87C212A1F58");
